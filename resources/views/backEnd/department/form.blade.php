            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-header justify-content-between">
                        ...
                        <a href="{{ route('departments.index') }}" class="btn btn-danger btn-sm text-white"  style="float: right text-decoration: none;">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card-body" style="padding: 10px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $department->name ?? old('name') }}" placeholder="Enter department name" autofocus>
